...
/***/ function(module, exports, __webpack_require__) {
	...
	var Multiplier = __webpack_require__(162);
	var Imgr = __webpack_require__(161);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-12' },
						React.createElement(Adder, { buildEquation: this.buildEquation })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Adder = React.createClass({
		...
		handleOperator: function handleOperator(event) {
			console.log('fire');
			...
			return React.createElement(
				...
				React.createElement(
					...
					this.state.buttons.map(function (button, i) {
						return React.createElement(
							'button',
							{ key: i, id: 'button{i}', className: 'btn btn-primary number', value: i, onClick: this.handleClick },
							i
						);
					}.bind(this)),
					...
					React.createElement(
						'button',
						{ id: 'buttonPlus', className: 'btn btn-danger operator', onClick: this.handleOperator, value: '+' },
						'+'
					),
					React.createElement(
						'button',
						{ id: 'buttonMultiply', className: 'btn btn-danger operator', onClick: this.handleOperator, value: '*' },
						'x'
					),
					React.createElement(
						'button',
						{ id: 'buttonMinus', className: 'btn btn-danger operator', onClick: this.handleOperator, value: '-' },
						'-'
					),
					React.createElement(
						'button',
						{ id: 'buttonDivide', className: 'btn btn-danger operator', onClick: this.handleOperator, value: '/' },
						'/'
					),
					React.createElement(
						'button',
						{ id: 'buttonPower', className: 'btn btn-danger operator', onClick: this.handleOperator, value: '^' },
						'^'
					),
					React.createElement('br', null),
					React.createElement('br', null),
					React.createElement(Imgr, { num1: this.state.number, op: this.state.operator, num2: this.state.number2 })
				)
			);
		}
	});
	...
	var Imgr = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					"button",
					{ id: "buttonEqual", className: "btn btn-success equal", onClick: this.equal, value: "equals" },
					React.createElement(
						"h1",
						null,
						"="
				...
				React.createElement(
					"button",
					{ id: "buttonClear", className: "btn btn-default clear", value: "clear" },
					React.createElement(
						"h1",
						null,
						"clear"
